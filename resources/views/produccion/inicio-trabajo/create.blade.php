...
@section('content')
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="x_panel">
                <div class="x_title row">
                    <div class="col-md-11">
                        <h2> Generar inicio de trabajo </h2>
                    </div>
                </div>
                <div class="x_content">
                    <div class="row">
                    ...
                    <div class="row"><br>
                        <div class="col-md-6">
                            <button class="btn btn-primary" data-save_start_work><i class="fa fa-diamond"></i> Generar inicio de Trabajo</button>
                        </div>
                        <div class="col-md-6">
    ...
    <input type="hidden" id="url_inicio_trabajo_store" value="{{ route('inicio_trabajo.store') }}">

    <input type="hidden" id="url_worker_data" value="{{ route('inicio_trabajo.trabajador.data','') }}">
    <input type="hidden" id="url_change_type_work" value="{{ route('inicio_trabajo.trabajador.change_type_work',['','']) }}">
    <input type="hidden" id="url_search_order" value="{{ route('inicio_trabajo.orden.search_order','') }}">
@endsection

@section('scripts')
    <script src="{{ asset('bootstrap-time/js/bootstrap-timepicker.js') }}"></script>
    <script src="{{ asset('js/produccion/inicio-trabajo/create.js') }}"></script>
@endsection